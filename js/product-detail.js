const products = {
    ...
    'ferda-signature':   { name: 'Ferda Signature, 2.4 oz',   price: 59.99,  image: 'images/fragrance8.jpg',                            bottleType: 'bottle-silver', brand: 'Ferda Fragrances', desc: 'The signature scent that defines the Ferda collection.' },
    'ferda-supreme':     { name: 'Ferda Supreme, 2.4 oz',     price: 9.99,   image: 'images/fragrance9.jpg',                            bottleType: 'bottle-silver', brand: 'Ferda Fragrances', desc: 'A premium fragrance at an unbeatable price.' },
    'ferda-ultimate':    { name: 'Ferda Ultimate, 2.4 oz',    price: 9.99,   image: 'images/fragrance10.jpg',                           bottleType: 'bottle-silver', brand: 'Ferda Fragrances', desc: 'The ultimate expression of the Ferda brand.' },
    'ferda-max':         { name: 'Ferda Max, 2.4 oz',         price: 9.99,   image: 'images/fragrance11.jpg',                           bottleType: 'bottle-silver', brand: 'Ferda Fragrances', desc: 'Maximum impact, maximum style.' },
    'ferda-godly':       { name: 'Ferda Godly, 2.4 oz',       price: 9.99,   image: 'images/fragrance12.jpg',                           bottleType: 'bottle-silver', brand: 'Ferda Fragrances', desc: 'A divine fragrance that transcends the ordinary.' }
};
